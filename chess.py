...
class spot:
    ...
    def pressed(self, op = ""):
        ...
        if mode == "unselected" and self.team == turn:
            ...
            reset()
            print(f"piece : {self.image}  / row : {self.r} / column : {self.c}")
            moves = []
            ...
            if "k" in self.piece:
                if self.c != 7:
                    if board[self.r,self.c + 1].team != self.team and not is_check(self.r,self.c + 1,"-",opp[self.team]):
                        moves.append((self.r,self.c + 1))
                if self.r != 7 and self.c != 7:
                    if board[self.r + 1,self.c + 1].team != self.team and not is_check(self.r + 1,self.c + 1,"-",opp[self.team]):
                        moves.append((self.r + 1,self.c + 1))
                if self.r != 7:
                    if board[self.r + 1,self.c].team != self.team and not is_check(self.r + 1,self.c,"-",opp[self.team]):
                        moves.append((self.r + 1,self.c))
...
board = np.array([
    ...
    [spot(4,0,"-=","w"),spot(4,1,"-=","b"),spot(4,2,"-=","w"),spot(4,3,"xk","b"),spot(4,4,"-=","w"),spot(4,5,"-=","b"),spot(4,6,"-=","w"),spot(4,7,"-=","b")],
